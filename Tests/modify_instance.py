...
class Test_create_instance():
    ...
    def test_access_resource_method(self, api_url, arrange_create_character, role, auth, code_except, client):
        ...
        result = client.Modify_req.modify_instance(api_url, unknown_instance, auth=auth)
    ...
    def test_positive_modify_instance(self, api_url, property, test_case, arrange_create_character, client):
        ...
        data_modify = client.Modify_req.modify_data_construct(property,test_case,arrange_create_character(api_url).json()['result']['name'])
        result = client.Modify_req.modify_instance(api_url, data_modify)
    ...
    def test_negative_modify_instance(self, property, test_case, api_url, arrange_create_character, client):
        data_modify = client.Modify_req.modify_data_construct(property, test_case,
